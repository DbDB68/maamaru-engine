# -*- coding: utf-8 -*-
"""演练实测入口：默认认人演习模式（只认人不打架）

用法:
  演习: ./.venv/Scripts/python.exe test_practice.py
  真打: ./.venv/Scripts/python.exe test_practice.py --real
"""
...
print(f"=== 演练{'认人演习' if dry else '真打'} ===")
for msg in agent.practice_stream(dry_run=dry):
    print(msg)
