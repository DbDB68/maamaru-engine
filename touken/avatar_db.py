...
# 形态结论总开关：2026-09-21 校准 v2（.tmp/avatar_calib.py，sweep 40 页
# 9-15 真帧 vs 快照 #22 已确认 134 行，(sword_id, kiwame_date) 指纹关联）
# 形态结论 79/79 = 100% 一致、身份 199/199 agree，阈值 0.88/0.08/0.05
# 验证站得住，正式上线。v1 的"25 把贴反"是真值链配错行（#19 老整列
# 代码等级误读+日期串行+cands[0] 凑行）的假结论，已撤回（§44.1 勘误）。
AVATAR_FORM_ENABLED = True
