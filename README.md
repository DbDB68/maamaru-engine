...
下一步试做不依赖自动化的纯净账房版：保留本丸家底、活动规划、手动战绩和资源流水，把麻麻露自动跑出的账与审神者自己打的账分开。先在真实使用里把录入和概览收拾顺手，再决定是否拆成独立仓库。
...
- 试做不依赖自动化的纯净账房版：从现有本丸页保留家底、活动规划、手动战绩和资源流水，去掉游戏控制依赖；麻麻露自动跑出的账与审神者自己打的账继续分开，再按真实使用体验决定是否拆成独立仓库；
