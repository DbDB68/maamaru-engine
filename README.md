...
**[下载最新版](https://github.com/DbDB68/maamaru-engine/releases/latest)** · **[使用说明](docs/user-manual.md)** · [v0.6.0 更新内容](docs/releases/v0.6.0.md) · [提交问题](https://github.com/DbDB68/maamaru-engine/issues)

## 欢迎回到我的本丸

![我的本丸首页：庭院里的小狐丸与狐之助、审神者档案、日常小记和心愿刀名单](docs/assets/v060-honmaru-home.png)
...
想自己安排今天干什么，就用**自定义工作流**：签到、万屋、内番、远征、演练、锻刀、江户城、异去、领任务奖励这些活儿都是积木，按喜欢的顺序垒起来，起名保存、钉到首页，一条流水线从头跑到尾。跑完还可以安排它退出游戏、关掉模拟器，或者直接让电脑休眠——睡前挂一条，まあ丸收完工自己下班。

![自定义工作流：把日常活儿垒成积木流水线，起名保存、一键运行](docs/assets/v060-workflow-editor.png)

![添加步骤：准备、后勤、出阵，挑好积木按顺序加入流程](docs/assets/v060-workflow-picker.png)
...
v0.6.0 带来了自定义工作流和我的本丸首页，接下来进入观察期：优先修真实出现的卡住、看不懂、对不上和不好纠正，不为了凑版本继续堆页面。Android 与电脑账房的数据联动先记录需求，等真有人持续使用以后再决定同步方式。详见 [近期待办](docs/product-roadmap.md)。
