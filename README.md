...
> **项目状态：稳步迭代中**
>
> まあ丸仍在快速迭代，但日常玩法已经过多轮实机运行与新用户验证：下载、安装、跑完一天日课不需要折腾。自动化无法覆盖游戏和网络的所有异常，遇到没见过的界面变化时它会选择安全停下并说明原因；万一遇到问题，带着日志来提 Issue 就好。
...
而记账只是起点。まあ丸想长成一张会自己翻账本的本丸晨报：点开就能看到这周本丸做了什么、家里最缺什么、接下来该为哪个活动攒资源——包括替国服策划掐指一算下个月会开什么。
...
| 📜 **本丸成绩单** | 分开记录まあ丸完成的任务、库存实际变化与审神者报备；资源日账按来源染色，连续相同支出自动折叠；汇总出阵用时、圈速、养护、小判每小时收益和演练胜负 |
| 🌸 **自动换队长保花** | 合战场与异去可按疲劳差自动换人：每圈出阵前把最轻松的成员换到队长位，差距不够或读不出疲劳就不动 |
| 🗺️ **王点前撤退** | 手动行军时读取小地图，确认下一步将进入王点便主动回本丸；认不清时继续正常行军 |
| ⛏️ **大阪城定层挂机** | 可指定 1～99F 和出阵圈数；例如固定 88F 连续挖地，而不是只能从一点进去的99F开始 |
| 🛡️ **连续作战恢复** | 刀装与手入各自独立开关；刀装破损时从部队记录自动补充，触发伤势条件后可手入、使用加速符，并继续没有跑完的圈数 |
...
目标是把「打开まあ丸的第一眼」变成一张本丸晨报：这一周干了什么、接下来推荐做什么、家里最缺什么、该为下一个活动攒什么——审神者只管决策，翻账本的活交给狐狸。

- 补齐活动板子、手形／令牌、锻刀结果和更多玩法的可确认收支
- 在现有资源日账基础上增加更直观的长期趋势、月报、年报和活动收益总结
- 帮助审神者发现无法解释的资源变化，但始终区分库存事实、流程归因和人工说明
- 根据本丸历史整理可执行建议：哪项资源最接近告急、按当前速度还能撑几次限锻、今天最值得先做什么；建议注明数据范围、缺失项和推断依据，且都要由审神者确认后才能执行
- 为限锻等资源密集型活动提前算缺口、定攒资源目标，而不是活动开了才发现小判见底
- 整理国服活动月历「千里眼」：国服排期稳定跟随日服约 2~3 年，可据此推测接下来的活动类型、提前规划本丸日程；具体日期与国服限定内容仍以国服公告为准（策划：你礼貌吗）
